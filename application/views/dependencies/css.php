...
<link href="<?= base_url("assets") ?>/global_assets/css/icons/fontawesome/styles.min.css" rel="stylesheet" type="text/css">
...
<link rel="stylesheet" type="text/css" href="<?= base_url("assets/") ?>assets/css/slider-pro.min.css" media="screen"/>